...
set WDIR = '/g/data/p66/ars599/gfdl-model/experiments/'${EXP}'/input/'
set TDIR = '/g/data/w40/dxd565/gfdl-model/tools-land-sea-mask-changes/cm2.1_paleo/'
...
% ars599 23102023 double the ocean depth
topo_new( 191:340, 61:120) = -80.; % shallow ocean
...
/apps/matlab/R2021b/bin/matlab -nodesktop -nodisplay -nosplash -r script_s3 > out.matlab.3.txt
...
#
/apps/matlab/R2021b/bin/matlab -nodesktop -nodisplay -nosplash -r script_s5  > out.matlab.4.txt
#
...
#
/apps/matlab/R2021b/bin/matlab -nodesktop -nodisplay -nosplash -r script_s6  > out.matlab.5.txt
#
...
#
/apps/matlab/R2021b/bin/matlab -nodesktop -nodisplay -nosplash -r script_s7  > out.matlab.6.txt
...
#
/apps/matlab/R2021b/bin/matlab -nodesktop -nodisplay -nosplash -r script_s8 > out.matlab.7.txt
#
# create -> cover_eo.nc
...
/apps/matlab/R2021b/bin/matlab -nodesktop -nodisplay -nosplash -r script_s9  > out.matlab.8.txt
...
# 
/apps/matlab/R2021b/bin/matlab -nodesktop -nodisplay -nosplash -r script_s10 > out.matlab.1.txt
